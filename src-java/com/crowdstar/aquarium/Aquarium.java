...
public class Aquarium extends Cocos2dxActivity {
    ...
    if (paramFile.isDirectory()) {
      ...
      while (true) {
        if (b < i) {
          ...
          if (file.isDirectory()) {
            clearDirectory(file);
          } else if (!file.getName().equals("da39a3ee5e6b4b0d3255bfef95601890afd80709.json")) {
  ...
  public boolean canPlayMusic() {
    return (this.pm.isScreenOn() && !this.paused && !this.keyguardManager.inKeyguardRestrictedInputMode());
  }
  
  protected void createEditableTextfield(final String text, int paramInt1, int paramInt2, float paramFloat) {
  ...
  protected Dialog onCreateDialog(int paramInt) {
    ...
    AlertDialog.Builder builder2 = builder1.setMessage(i).setCancelable(true).setTitle(R.string.new_version_dialog_title).setPositiveButton(R.string.new_version_dialog_ok, new 
    ...
    if (paramInt == 1) {
      ...
      builder2.setNegativeButton(paramInt, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface param1DialogInterface, int param1Int) {
              if (param1Int == 1)
  ...
  private static boolean access$302(Aquarium paramAquarium, boolean paramBoolean) {
    paramAquarium.refreshMusicState = paramBoolean;
    return paramBoolean;
  }
  
  private static boolean access$602(Aquarium paramAquarium, boolean paramBoolean) {
  ...
  public static native void androidFBRecievedAppRequestResponse(String paramString);
  ...
  public static native void androidFBRecievedFriendsUsing(String[] paramArrayOfString);
  
  public static native void androidFBRecievedUserInfo(String paramString1, String paramString2, String paramString3);
