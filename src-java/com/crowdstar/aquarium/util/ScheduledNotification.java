...
public class ScheduledNotification extends BroadcastReceiver {
  ...
  public void onReceive(Context paramContext, Intent paramIntent) {
    ...
    Notification notification = new Notification(2130837506, str1, System.currentTimeMillis());
    PendingIntent pendingIntent = PendingIntent.getActivity(paramContext, 0, new Intent(paramContext, Aquarium.class), 0);
    notification.setLatestEventInfo(paramContext.getApplicationContext(), str1, str2, pendingIntent);
    notificationManager.notify(1, notification);
  }
}


/* Location:              /home/jason/Pobrane/fish.jar!/com/crowdstar/aquarium/util/ScheduledNotification.class
