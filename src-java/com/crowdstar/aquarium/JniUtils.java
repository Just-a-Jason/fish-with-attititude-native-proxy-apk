...
public class JniUtils {
  ...
  private static native void addProductData(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5);
  
  public static void appRequestDialog(String paramString1, String paramString2, String paramString3, String paramString4) { }
  ...
  public static void createEditableTextfield(String paramString, int paramInt1, int paramInt2, float paramFloat) {
    Aquarium.INSTANCE.createEditableTextfield(paramString, paramInt1, paramInt2, paramFloat);
  }
  ...
  protected static native void finishTransaction(String paramString1, int paramInt, String paramString2);
  ...
  public static String getMACAddress() {
    String str2 = ((WifiManager)getApplicationContext().getSystemService("wifi")).getConnectionInfo().getMacAddress();
    String str1 = str2;
    if (str2 == null)
      str1 = "d34db33fd34db33f"; 
    return str1;
  }
  ...
  public static String getStringUserDefault(String paramString) {
    return PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getString(paramString, "");
  }
  
  // Unused empty function
  public static void getTapPoints() { }
  
  public static String getUUID(String paramString1, String paramString2, boolean paramBoolean) {
  ...
  public static void postAchievement(String paramString1, String paramString2) { }
  ...
  public static void scheduleFutureNotification(String paramString1, String paramString2, int paramInt, String paramString3) {
    Calendar calendar = Calendar.getInstance();
    calendar.add(12, paramInt);
    LocalNotifications.scheduleFutureNotification(getApplicationContext(), paramString1, paramString2, calendar.getTimeInMillis(), paramString3);
  }
  ...
  public static void sendEasyTweet() {
    ...
    String str = aquarium.getString(2131034144, new Object[] { aquarium.getString(2131034114), aquarium.getPackageName() });
    Intent intent = new Intent("android.intent.action.SEND");
    intent.setType("text/plain");
    intent.putExtra("android.intent.extra.TEXT", str);
    aquarium.startActivity(Intent.createChooser(intent, aquarium.getString(2131034143)));
  }
  
  public static void sendFacebookWallpost(String paramString1, String paramString2, String paramString3, String paramString4) { }
  
  private static void sendMail(Activity paramActivity, String paramString1, String paramString2, String paramString3) {
    Intent intent = new Intent("android.intent.action.SEND");
    ...
    paramActivity.startActivity(Intent.createChooser(intent, paramActivity.getString(2131034139)));
  }
  
  public static void sendText() {
    Aquarium aquarium = Aquarium.INSTANCE;
    Intent intent = new Intent("android.intent.action.SENDTO", Uri.parse("smsto:"));
    intent.putExtra("sms_body", aquarium.getString(2131034136, new Object[] { aquarium.getString(2131034114), aquarium.getPackageName() }));
  ...
  public static void setStringUserDefault(String paramString1, String paramString2) {
  ...
  public static void showMailComposer() {
    Context context = getApplicationContext();
    String str1 = context.getString(2131034137, new Object[] { context.getString(2131034114) });
    String str2 = context.getString(2131034138, new Object[] { context.getString(2131034114), context.getPackageName() });
  ...
  public static void showNewVersionAlert(final boolean forceUpdate) {
    Aquarium.INSTANCE.runOnUiThread(new Runnable() {
          public void run() {
            byte b;
            Aquarium aquarium = Aquarium.INSTANCE;
            if (forceUpdate) {
  ...
  public static void startPostToFacebook(String paramString1, String paramString2) {}
  ...
  public static void uploadFileToPhotoAlbumWithMessage(String paramString1, String paramString2) { }
}


/* Location:              /home/jason/Pobrane/fish.jar!/com/crowdstar/aquarium/JniUtils.class
