...
pub(crate) type NativeAppInitJNI =
    unsafe extern "C" fn(env: *mut RawJNIEnv, path: *const c_char) -> u64;
...
pub(crate) type FnConnectedToIntarweb = unsafe extern "system" fn(*mut RawJNIEnv, jclass, jint);
